...
{	
	...
	//		ham=1/((x-0.5)*(x-0.5)+tiny);		//3137.58	1e-6	19		//314153	1e-10	15	//3.141458e+08		1e-16
	
	//		ham=(1/((x-0.5)*(x-0.5)) + (1/((x-0.75)*(x-0.75)+tiny)));		//6273.85	1e-6	27		//628309.19		1e-10		//6.28318x10^8	1e-16
	
	//		ham=(1/((x-0.5)*(x-0.5)+tiny)) + (1/((y-0.75)*(y-0.75)+tiny));		//6273.85	1e-6	27	//628309	1e-10	2	//1e-16	
	
			ham=1/((x-0.5)*(x-0.5) + (y-0.75)*(y-0.75)+tiny);		//38.97365		1e-6	9	//67.90724	1e-10	 12	//111.3065		1e-16
	return ham;
}
